...
impl GatewayError {
    pub fn status_code(&self) -> StatusCode {
        match self {
            ...
            Self::MissingService | Self::MissingDebugBundle | Self::MissingUsageEvent => {
    ...
    pub fn code(&self) -> &'static str {
        match self {
            ...
            Self::MissingUsageEvent => "request_not_found",
    ...
    pub fn public_message(&self) -> &'static str {
        match self {
            ...
            Self::MissingUsageEvent => "No request exists for the supplied request ID.",
