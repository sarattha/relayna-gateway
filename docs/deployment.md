...
UI 2.0 is compiled into the same static asset contract, and provider
intelligence, operator governance, usage analytics, audit, Entra, Apigee, and
LiteLLM controls remain on the same gateway binary. See
