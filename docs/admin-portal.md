...
- Routes disables and enables the global OpenAI-compatible LiteLLM routes `/v1/chat/completions` and `/v1/responses`.
- Services creates, imports, edits, sync-checks, disables, enables, and deletes service registrations.
